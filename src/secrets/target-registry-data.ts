...
const CORE_SECRET_TARGET_REGISTRY: SecretTargetRegistryEntry[] = [
  ...
  {
    id: "channels.telegram.accounts.*.tts.elevenlabs.apiKey",
    targetType: "channels.telegram.accounts.*.tts.elevenlabs.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.telegram.accounts.*.tts.elevenlabs.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.telegram.accounts.*.tts.openai.apiKey",
    targetType: "channels.telegram.accounts.*.tts.openai.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.telegram.accounts.*.tts.openai.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.telegram.accounts.*.tts.gemini.apiKey",
    targetType: "channels.telegram.accounts.*.tts.gemini.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.telegram.accounts.*.tts.gemini.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.telegram.tts.elevenlabs.apiKey",
    targetType: "channels.telegram.tts.elevenlabs.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.telegram.tts.elevenlabs.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.telegram.tts.openai.apiKey",
    targetType: "channels.telegram.tts.openai.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.telegram.tts.openai.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "channels.telegram.tts.gemini.apiKey",
    targetType: "channels.telegram.tts.gemini.apiKey",
    configFile: "openclaw.json",
    pathPattern: "channels.telegram.tts.gemini.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
  ...
  {
    id: "messages.tts.gemini.apiKey",
    targetType: "messages.tts.gemini.apiKey",
    configFile: "openclaw.json",
    pathPattern: "messages.tts.gemini.apiKey",
    secretShape: SECRET_INPUT_SHAPE,
    expectedResolvedValue: "string",
    includeInPlan: true,
    includeInConfigure: true,
